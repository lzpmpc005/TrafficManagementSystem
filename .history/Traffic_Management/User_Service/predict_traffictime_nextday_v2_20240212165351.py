...
def predict_next_day_traffic(folder_name):
    ...
    for i in range(5):
        ...
        folder_name = f'/Users/charton/Git/TrafficManagementSystem/{folder_name}'
        days[formatted_date] = []
...
traffic_prediction = predict_next_day_traffic(folder_name)
for item in traffic_prediction:
    print(item)
